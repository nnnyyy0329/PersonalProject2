...
PlayerAttackComponent::PlayerAttackComponent()
{
	...
	weak1.hitMoveData.moveSpeed				= 5.0f;
	weak1.hitMoveData.moveTime				= 30.0f;
	...
	weak2.hitMoveData.moveSpeed				= 5.0f;
	weak2.hitMoveData.moveTime				= 30.0f;
	...
	weak3.hitMoveData.moveDirection			= { 0.0f, 0.0f, 1.0f };
	weak3.hitMoveData.moveSpeed				= 5.0f;
	weak3.hitMoveData.moveTime				= 30.0f;
	...
	weak4.hitMoveData.moveDirection			= { 1.0f, 0.0f, 0.0f };
	weak4.hitMoveData.moveSpeed				= 5.0f;
	weak4.hitMoveData.moveTime				= 30.0f;
	...
	weak5.damageData.damage					= 5.0f;
	weak5.damageData.hitStunTime			= 0.0f;
	weak5.damageData.damageInvincibeTime	= 0.0f;
	weak5.hitMoveData.moveDirection			= { 0.0f, 0.0f, 1.0f };
	weak5.hitMoveData.moveSpeed				= 5.0f;
	weak5.hitMoveData.moveTime				= 30.0f;
